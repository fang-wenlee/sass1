  ...
  $(document).ready(function(e) {
    ...
    if(!pId ){
              ...
              $.each(data, function (key, val) {
                ...
                let discountPrice =0;
                 output += `<div class="flexbox-item">
                  <a href=item2.html?pId=${val.prodId} >
                 <div class="posts-img" 
                 style="background:url(${val.imageURL});background-size:cover; background-position:center;" >
                 </div>
                 </a>
  
                 <form method="get" class="basket_add_prod" id="basket_add_prod_${key}" >`;
                     ...
                     if(val.onSale){
                         ...
                         output += `${formStr}
                                    ...
                                    <div class="onsale-price" style="height:40px">
                                        ...
                                        <span style="color:red;"> You pay:<b> $ ${discountPrice}</b></span> 
                                    </div>`
                     }else{
               ...
               //===========================================================================
                 ...
                 if(val.onSale){
                     output +=  `<img src = "../../images/site/cashback-icon.svg" width="15px" height="15px"/>
        ...
        $.each(prod, function (key, val) {
          ...
          <a href=item2.html?pId=${val.prodId} >
          <div class="posts-img"
          style="background:url(${val.mediumImageURL}); no-repeat  background-size:cover; background-position:center;" >
          </div>
          </a>`;
        ...
        //===========================================================================
          ...
          if(val.onSale){
              output +=  `<img src = "../../images/site/cashback-icon.svg" width="15px" height="15px"/>
                           <span style="color:Red; padding-left:5px;"><b>${val.discount}% off </b></span>
                           </div>`;        
          }
  ...
  // ======use for product-detail page============================================================
    ...
    // item right================== product detail
                      ...
                      if(proObj[0].onSale) {
                        ...
                        discountStr = `
                              <img src = "../../images/site/cashback-icon.svg" width="20px" height="20px" />
                              <span style="color:Red; padding-left:5px;"><b>${proObj[0].discount}% off</b></span>`       
                      ...
                      if (proObj[0].isAvailable) {
                        output += `<div class="price-box">
                                  ...
                                  <div class="sale-price-item item ${onSaleStr}>
                                     ...
                                     <span id="sale-price-percent">$ ${afterDiscount} </span>
                                  </div>
  ...
  var basket = {
    ...
    data.map(item=> {
          ...
          <div class="flexbox-img-item item">  
              <img src="../../images/site/cashback-icon.svg" width="70px" height="70x"/>
          </div>
    ...
    changeQty: function(e){
      let productArray = JSON.parse($.cookie('basket-data'));
        ...
        let updateQty=  productArray.filter(item=> item.prodId == e.target.id);
   ...
   //newItem.logItem();
    ...
    if ($.cookie('basket-data')  ) { // 
        ...
        if(  cookieItem.length == 1  ){
              ...
              $.cookie('total', ( parseInt ( $.cookie('qty')) *   parseFloat (cookieItem[0].unitprice) ));
              console.log("qty: ", cookieArray[0].quantity)
          
             $.cookie('basket-data', JSON.stringify(cookieArray));
                console.log("qty" ,$.cookie('basket-data'));
              return true;  
        }else 
